...
<html lang="en">
  ...
  <body>
    ...
    <div>
      ...
      <input name="transport" id="transport" type="text" value="Transport 1" placeholder="Transport name" required/>
      </p>
      <p><b>Object1:</b></p>
      Square <input class="cinpt01" type="radio" id="objecttype11" name="objecttype11" value="square">
      Cirle <input class="cinpt01" type="radio" id="objecttype12" name="objecttype11" value="circle" checked>
      ...
      <input name="radius11" id="radius11" type="number" value="50" min="0"/>
      </p>
      </div>
      ...
      <input name="radius21" id="radius21" type="number" value="50" min="0"/>
      </p>
      </div>

      <div>
      <p><b>Object3:</b></p>
      Square <input class="cinpt01" type="radio" id="objecttype31" name="objecttype31" value="square" checked>
      ...
      <input name="width31" id="width31" type="number" value="100" min="0"/>
      </p>
      <p><label id="lblLength31">Length:</label>
      <input name="length31" id="length31" type="number" value="100" min="0"/>
      </p>
