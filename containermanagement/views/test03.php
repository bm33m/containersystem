...
<html lang="en">
  ...
  <body>
    ...
    <div>
      ...
      <input name="transport" id="transport" type="text" value="Transport 3" placeholder="Transport name" required/>
      </p>
      <p><b>Object1:</b></p>
      ...
      <input name="width11" id="width11" type="number" value="100" min="0"/>
      </p>
      <p><label id="lblLength">Length:</label>
      <input name="length11" id="length11" type="number" value="100" min="0"/>
      </p>
      ...
      <div>
      <p><b>Object2:</b></p>
      Square <input class="cinpt01" type="radio" id="objecttype21" name="objecttype21" value="square" checked>
      Cirle <input class="cinpt01" type="radio" id="objecttype22" name="objecttype21" value="circle">
      Other <input class="cinpt01" type="radio" id="objecttype23" name="objecttype21" value="other">
      <p><label id="lblWidth21">Width:</label>
      <input name="width21" id="width21" type="number" value="50" min="0"/>
      </p>
      <p><label id="lblLength21">Length:</label>
      <input name="length21" id="length21" type="number" value="50" min="0"/>
      </p>
      <p><label id="lblRadius21">Radius:</label>
      <input name="radius21" id="radius21" type="number" min="0"/>
      </p>
      </div>
      ...
      Cirle <input class="cinpt01" type="radio" id="objecttype32" name="objecttype31" value="circle" checked>
      Other <input class="cinpt01" type="radio" id="objecttype33" name="objecttype31" value="other">
      ...
      <input name="radius31" id="radius31" type="number" value="50" min="0"/>
      </p>
      </div>
