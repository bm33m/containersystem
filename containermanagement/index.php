...
<html lang="en">
  ...
  <body>
    <header class="navbar">
      <ul>
        <li><a href="./views/containers.php">containers</a></li>
        <li><a href="./views/objects.php">objects</a></li>
        <li><a href="./views/test01.php">test01</a></li>
        <li><a href="./views/test02.php">test02</a></li>
        <li><a href="./views/test03.php">test03</a></li>
      </ul>
    </header>
    <div>
    ...
    <div id="info" class="gdvuiprofile">
      <a href="#/./views/containers.php"><img src="./public/assets/pro2020.jpg"/>containers</a>
    </div>
    ...
    <div>
      ...
      <input name="transport" id="transport" type="text" value="" placeholder="Transport name" required/>
      </p>
      <p><b>Object1:</b></p>
      ...
      Other <input class="cinpt01" type="radio" id="objecttype23" name="objecttype21" value="other" checked>
